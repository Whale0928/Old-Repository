...
<body>
	...
	<jsp:include page="../common/header.jsp"></jsp:include>
		...
		<div class="chatting-area">
			...
			<ul class="display-chatting" id=chat-box>
	...
	<script>
		...
		//websocket 프로토콜을 이용해 해당 주소로 요청을 전달하게 됨
		...
		*전이중 통신 (Full Duplex) : 두대의 단말기가 데이터를 송수신 하기 위해
			각각 독립된 회선을 사용하는 통신 방식 (ex. 전화)
		
		
		-	 HTML5 부터 지원
		-	java 7 부터 지원 (8버전 이상 사용 권장)
		-	Spring Framework 4이상 지원.

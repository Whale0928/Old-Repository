    ...
    <main>
       <jsp:include page="/WEB-INF/views/common/header.jsp"/>
        ...
        <section class="myPage-content">
            ...
            <!-- 오른쪽 마이페이지 주요 내용 부분 -->
            <section class="myPage-main" style="position:relative">
...
<%-- ----------------------------------------------------------- --%>
                    <div id="wrap" style="display:none;border:1px solid green;width:500px;height:300px;margin:5px 0;position:absolute;z-index:11;">

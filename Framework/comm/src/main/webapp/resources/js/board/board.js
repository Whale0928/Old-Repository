...
(function () {
    ...
    if (goToListBtn != null) { // 목록으로 버튼이 화면에 있을 때만 이벤트 추가
        ...
        goToListBtn.addEventListener("click", function () {
            ...
            url += "/board/list/" + boardCode + "?"    // /board/list/1?cp=
            ...
            //현재
            //http://localhost:8080/comm/board/detail/1/496?cp=1
...
(function () {
    ...
    if (deleteBtn != null) { // 버튼이 화면에 존재할 때
        deleteBtn.addEventListener("click", function () {
            ...
            let url = "../../delete/"+boardCode+"/"+boardNo; // 상대경로 형식으로 작성
            ...
            //http://localhost:8080/comm/board/detail/3/delete?no=null&type=null
            //http://localhost:8080/comm/board/detail/3/1536?cp=1

            //http://localhost:8080/comm/board/detail/3/1536?cp=1
            //http://localhost:8080/comm/board/delete/3/1536
        });
    }

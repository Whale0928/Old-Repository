    ...
    $.ajax({
        ...
        success: function (rList) {
            ...
            for (let reply of rList) {
                ...
                //답글일 경우
                if(reply.parentReplyNo > 0 && reply.parentReplyNo <= 2){ replyRow.classList.add("child-reply");  };
                if(reply.parentReplyNo >= 2){ replyRow.classList.add("grandson-reply");  };
                ...
                //로그인이 되어 있는 경우 답글 버튼 추가
                if (loginMemberNo != "") { //전역변수로 만들어놔서 안되어 있으면 null
                    // 버튼 영역
